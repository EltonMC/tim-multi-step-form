...
var appRoutes = [
    ...
    // 4th Route
    { path: 'result', component: _result_result_component__WEBPACK_IMPORTED_MODULE_5__["ResultComponent"], canActivate: [_workflow_workflow_guard_service__WEBPACK_IMPORTED_MODULE_6__["WorkflowGuard"]] },
    // 5th Route
...
var AppRoutingModule = /** @class */ (function () {
    ...
    AppRoutingModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forRoot(appRoutes, { useHash: true }), ngx_mask__WEBPACK_IMPORTED_MODULE_7__["NgxMaskModule"].forRoot()],
...
/* harmony import */ var _plan_plan_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./plan/plan.component */ "./src/app/plan/plan.component.ts");
...
/* harmony import */ var _data_formData_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./data/formData.service */ "./src/app/data/formData.service.ts");
/* harmony import */ var _workflow_workflow_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./workflow/workflow.service */ "./src/app/workflow/workflow.service.ts");
...
/* harmony import */ var _services_email_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./services/email.service */ "./src/app/services/email.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            providers: [
                { provide: _services_email_service__WEBPACK_IMPORTED_MODULE_14__["EmailService"], useClass: _services_email_service__WEBPACK_IMPORTED_MODULE_14__["EmailService"] },
                { provide: _data_formData_service__WEBPACK_IMPORTED_MODULE_11__["FormDataService"], useClass: _data_formData_service__WEBPACK_IMPORTED_MODULE_11__["FormDataService"] },
                { provide: _workflow_workflow_service__WEBPACK_IMPORTED_MODULE_12__["WorkflowService"], useClass: _workflow_workflow_service__WEBPACK_IMPORTED_MODULE_12__["WorkflowService"] }
            ],
            declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _navbar_navbar_component__WEBPACK_IMPORTED_MODULE_5__["NavbarComponent"], _location_location_component__WEBPACK_IMPORTED_MODULE_6__["LocationComponent"], _plan_plan_component__WEBPACK_IMPORTED_MODULE_7__["PlanComponent"], _person_person_component__WEBPACK_IMPORTED_MODULE_8__["PersonComponent"], _result_result_component__WEBPACK_IMPORTED_MODULE_9__["ResultComponent"]],
...
/*!****************************************!*\
  !*** ./src/app/data/formData.model.ts ***!
  \****************************************/
/*! exports provided: FormData, Location, Person, Address */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _assets_data_4g_tim_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../assets/data/4g-tim.json */ "./src/assets/data/4g-tim.json");
var _assets_data_4g_tim_json__WEBPACK_IMPORTED_MODULE_5___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../assets/data/4g-tim.json */ "./src/assets/data/4g-tim.json", 1);
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LocationComponent = /** @class */ (function () {
    function LocationComponent(router, formDataService, emailService) {
        this.router = router;
        this.formDataService = formDataService;
    ...
    LocationComponent.prototype.save = function (form) {
        ...
        _assets_data_4g_tim_json__WEBPACK_IMPORTED_MODULE_5__.map(function (data) { if (_this.removeAcento(data) === _this.removeAcento(_this.location.city.toUpperCase()))
    ...
    LocationComponent.prototype.goToNext = function (form) {
        ...
        this.emailService.send('[TIM] Disponibilidade ', body).subscribe(function (res) {
            if (_this.save(form)) {
    ...
    LocationComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _data_formData_service__WEBPACK_IMPORTED_MODULE_3__["FormDataService"], _services_email_service__WEBPACK_IMPORTED_MODULE_0__["EmailService"]])
    ], LocationComponent);
...
var PersonComponent = /** @class */ (function () {
    function PersonComponent(router, formDataService, emailService) {
        this.router = router;
        this.formDataService = formDataService;
        this.emailService = emailService;
    }
    ...
    PersonComponent.prototype.goToNext = function (form) {
        ...
        if (this.save(form)) {
            this.emailService.send('[TIM] Contrate Agora', body).subscribe(function (res) {
...
/* harmony import */ var _assets_data_plans_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../assets/data/plans.json */ "./src/assets/data/plans.json");
var _assets_data_plans_json__WEBPACK_IMPORTED_MODULE_3___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../assets/data/plans.json */ "./src/assets/data/plans.json", 1);
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PlanComponent = /** @class */ (function () {
    function PlanComponent(router, formDataService) {
        this.router = router;
        this.formDataService = formDataService;
    ...
    PlanComponent.prototype.ngOnInit = function () {
        this.plans = _assets_data_plans_json__WEBPACK_IMPORTED_MODULE_3__;
    ...
    PlanComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _data_formData_service__WEBPACK_IMPORTED_MODULE_2__["FormDataService"]])
    ], PlanComponent);
...
module.exports = ["AGUAS LINDAS DE GOIAS","ANANINDEUA","ARACAJU","ARAPIRACA","BELEM","BOA VISTA","BRASILIA","CABO DE SANTO AGOSTINHO","CACHOEIRO DE ITAPEMIRIM","CAMACARI","CAMARAGIBE","CAMPO GRANDE","CANDEIAS","CARAZINHO","CARIACICA","CHAPECO","CONCORDIA","CUIABA","ERECHIM","FEIRA DE SANTANA","FORTALEZA","GRAVATA","GUARAPARI","GURUPI","ILHEUS","IMPERATRIZ","ITABUNA","JABOATAO DOS GUARARAPES","JEQUIE","JOACABA","JOAO PESSOA","MACAPA","MACEIO","MANAUS","MARABA","MARACANAU","MONTES CLAROS","MOSSORO","NATAL","OLINDA","PALMAS","PARNAMIRIM","PASSO FUNDO","PATOS DE MINAS","PAULISTA","PETROLINA","PORTO SEGURO","PORTO VELHO","RECIFE","RIO BRANCO","RIO VERDE","RONDONOPOLIS","SALVADOR","SANTA INES","SAO LUIS","SENHOR DO BONFIM","SERRA","SIMOES FILHO","TERESINA","UBERABA","UBERLANDIA","VARZEA GRANDE","VILA VELHA","VITORIA","VITORIA DA CONQUISTA","XANXERE"];
...
/***/ "./src/assets/data/plans.json":
/*!************************************!*\
  !*** ./src/assets/data/plans.json ***!
  \************************************/
/*! exports provided: fibra, fourG, default */
/***/ (function(module) {

module.exports = {"fibra":[{"id":1,"title":"40 MEGA","description":"20 Mega de Upload","price":105.8},{"id":2,"title":"60 MEGA","description":"30 Mega de Upload","price":105.8},{"id":3,"title":"100 MEGA","description":"60 Mega de Upload","price":117},{"id":4,"title":"150 MEGA","description":"60 Mega de Upload","price":144},{"id":5,"title":"300 MEGA","description":"180 Mega de Upload","price":180},{"id":6,"title":"500 MEGA","description":"250 Mega de Upload","price":450},{"id":7,"title":"1 GIGA","description":"300 Mega de Upload","price":860},{"id":8,"title":"2 GIGA","description":"500 Mega de Upload","price":1560}],"fourG":[{"id":101,"title":"2 MEGA","description":"2MB DE VELOCIDADE","price":83.9},{"id":102,"title":"4 MEGA","description":"4MB DE VELOCIDADE","price":109.9}]};
...
module.exports = __webpack_require__(/*! C:\Users\elton\OneDrive\Documentos\Repository\tim-multi-step-form\src\main.ts */"./src/main.ts");
